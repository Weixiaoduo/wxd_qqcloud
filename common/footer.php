	...
	<div id="ft" class="wp cl">
		<div id="flk" class="y">
			<p>
				...
				<!--{if $_G['setting']['icp']}-->( <a href="http://www.miitbeian.gov.cn/" target="_blank" rel="nofollow">$_G['setting']['icp']</a> )<!--{/if}-->
		...
		<div id="frt">
			<p>Powered by <strong>Discuz!</a></strong> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}--></p>
			<p class="xs0">&copy; 2012-2015 <a href="http://www.Weixiaoduo.com" target="_blank">Weixiaoduo.com</a>
</p>
		</div>
		<!--{eval updatesession();}-->
...
<div id="scrolltop">
	...
	<span><a href="forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]&extra=$_GET[extra]&page=$page{if $_GET[from]}&from=$_GET[from]{/if}" onclick="showWindow('reply', this.href)" class="replyfast" title="快速回复"><b>快速回复</b></a></span>
	<!--{/if}-->
